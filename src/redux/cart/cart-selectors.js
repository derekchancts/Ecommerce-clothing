...
//     (accumalatedQuantity, cartItem) => accumalatedQuantity + cartItem.quantity, 0) : 0
// )
...
//   [selectCartItems],
//   cartItems => cartItems ? cartItems.reduce(
//     (accumalatedQuantity, cartItem) => accumalatedQuantity + (cartItem.price * cartItem.quantity), 0) : 0
// )